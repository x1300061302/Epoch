...
MODULE shared_parser_data
  ...
  INTEGER, PARAMETER :: c_func_bessel_k2 = 47
...
MODULE shared_data
  ...
  !Use to add more variables
  INTEGER, PARAMETER :: num_vars                 = 53


#ifdef WORK_DONE_INTEGRATED
  INTEGER, PARAMETER :: c_dump_part_work_x       = num_vars + 1
  INTEGER, PARAMETER :: c_dump_part_work_y       = num_vars + 2
  INTEGER, PARAMETER :: c_dump_part_work_z       = num_vars + 3 
  INTEGER, PARAMETER :: c_dump_part_work_x_total = num_vars + 4 
  INTEGER, PARAMETER :: c_dump_part_work_y_total = num_vars + 5
  INTEGER, PARAMETER :: c_dump_part_work_z_total = num_vars + 6
  INTEGER, PARAMETER :: num_work = 6
#else
...
#ifdef PHOTONS
  !Xiey eta & chi
  INTEGER, PARAMETER :: c_dump_part_eta          = num_vars + num_work + 1
  INTEGER, PARAMETER :: c_dump_part_minus_energy = num_vars + num_work + 2
  INTEGER, PARAMETER :: num_pho = 2
#else 
