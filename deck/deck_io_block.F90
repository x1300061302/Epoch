...
#ifdef PHOTONS
    !Xiey
    io_block%dumpmask(c_dump_part_eta) = &
        IOR(io_block%dumpmask(c_dump_part_eta), c_io_restartable)
    io_block%dumpmask(c_dump_part_minus_energy) = &
        IOR(io_block%dumpmask(c_dump_part_minus_energy), c_io_restartable)
    !end Xiey
